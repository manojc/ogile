...
export class StorageService {
    ...
    public getItem(key: string, storageType: "local" | "session" | "cookie" = "cookie"): Object {
    ...
    public setItem(key: string, value: any, storageType: "local" | "session" | "cookie" = "cookie"): boolean {
